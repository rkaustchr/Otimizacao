...
%     PROBLEMA TESTE no.2 - EXTENDED POWELL SINGULAR FUNCTION
%
...
fprintf(1,'\n **** PROBLEMA TESTE No.2 - EXTENDED POWELL SINGULAR FUNCTION *** \n\n') 
nvar= input('> digite o número de variáveis (qualquer número positivo mútiplo de 4): ') ;    % numero de variaveis
...
nprob=02;  % Nr. of the problem to be solved, required when
...
fun='fun02';   % File with the MATLAB function that computes
               % the Objective and the Constraints.

gfun='gfun02'; % File with the MATLAB function that computes
