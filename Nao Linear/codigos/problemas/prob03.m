...
%
%    PROBLEMA TESTE No.3 - TRIGONOMETRIC FUNCTION
%
...
fprintf(1,'\n **** PROBLEMA TESTE No.3 - TRIGONOMETRIC FUNCTION *** \n\n') 
nvar= input('> digite o número de variáveis (qualquer número positivo): ') ;    % numero de variaveis
...
fun='fun03';   % File with the MATLAB function that computes
               % the Objective and the Constraints.

gfun='gfun03'; % File with the MATLAB function that computes
